...
val String?.orNotAvailable get() =
    if (this == null || this == emptyString || this == 0.toString()) Const.NOT_AVAILABLE else this
...
val Long?.orNotAvailable: String get() =
    if (this == null || this == emptyLong) Const.NOT_AVAILABLE else this.toString()
...
val Float?.orNotAvailable: String get() =
    if (this == null || this == emptyFloat) Const.NOT_AVAILABLE else this.toString()
...
val Int?.orNotAvailable: String get() =
    if (this == null || this == emptyInt) Const.NOT_AVAILABLE else this.toString()
...
val Double?.orNotAvailable: String get() =
    if (this == null || this == emptyDouble) Const.NOT_AVAILABLE else this.toString()
