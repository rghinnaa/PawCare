...
import androidx.navigation.ui.R as PawcareR
...
private fun commitTransaction(
    ...
    fragmentManager.beginTransaction()
        .setCustomAnimations(
            PawcareR.anim.nav_default_enter_anim,
            PawcareR.anim.nav_default_exit_anim,
            PawcareR.anim.nav_default_pop_enter_anim,
            PawcareR.anim.nav_default_pop_exit_anim
        )
...
fun NavController.popToStartDestination(inclusive: Boolean = false) =
    popBackStack(graph.startDestinationId, inclusive)
...
fun NavController.navigateOrNull(direction: NavDirections?, clearTask: Boolean = false) {
    try {
        val options = NavOptions.Builder().apply {
            setEnterAnim(PawcareR.anim.nav_default_enter_anim)
            setExitAnim(PawcareR.anim.nav_default_exit_anim)
            setPopEnterAnim(PawcareR.anim.nav_default_pop_enter_anim)
            setPopExitAnim(PawcareR.anim.nav_default_pop_exit_anim)
